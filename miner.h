...
extern int scanhash_x16gs(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done);
...
extern void free_x16gs(int thr_id);
...
void x16gs_hash(void *output, const void *input);
