...
// Sibcoin CPU Hash
extern "C" void x16gs_hash(void *output, const void *input)
{
...
//#define _DEBUG
#define _DEBUG_PREFIX "x16gs"
#include "cuda_debug.cuh"

static bool init[MAX_GPUS] = { 0 };
static bool use_compat_kernels[MAX_GPUS] = { 0 };

extern "C" int scanhash_x16gs(int thr_id, struct work* work, uint32_t max_nonce, unsigned long *hashes_done)
{
...
// cleanup
extern "C" void free_x16gs(int thr_id)
{
	if (!init[thr_id])
		return;
